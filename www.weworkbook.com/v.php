  ...
  <body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-8 text-center">
                <h1 class="logo"><a href="/">WEWORKBOOK</a></h1>
            </div>
    ...
    <div class="container-fluid" id="menu" style="display:none">
        ...
        <div class="col text-right">
            ...
            <p class="lead"><a href="/training-company.php">Training Companies</a></p>
            <p class="lead"><a href="/consultant.php">Consultants</a></p>
            <p class="lead"><a href="/testimonials.php">Testimonials</a></p>
            <p class="lead"><a href="/one-minute-snapshots.php">One Minute Snapshots</a></p>
            <p class="lead"><a href="/blog.php">Blog</a></p>
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form accept-charset="UTF-8" role="form" id="login_form" name="login_form" method="post" action="user/login.php" onsubmit="return showTimeZone();">
                                <div class="form-row">
                ...
                <div class="form-row">
                    <small id="passwordHelpBlock" class="form-text text-muted">
                        <a href="/forgetpassword.php" target="_blank">Forgot Password</a>
                        </small>
...
<script src="/dist/js/scripts.min.js"></script></body>
</html>